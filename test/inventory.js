    ...
    defineAdditionalTests({ suite }) {
        suite("object inventory", getHarness => {
            ...
            it("covers every account type, not only the maintainer's", async function () {
                ...
                for (const account of ["claude", "chatgpt", "gemini", "fixture-openrouter-api", "fixture-deepseek-api", "fixture-openai-api", "fixture-anthropic-api"]) {
                ...
                for (const suffix of ["claude.limits.session.percent", "claude.limits.session.active", "chatgpt.credits.resetCredits", "fixture-openai-api.costs.month", "fixture-openai-api.models"]) {
